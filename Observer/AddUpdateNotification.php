...
namespace ETechFlow\AdminReindex\Observer;
 ...
 * of Admin Reindex is published to the eTechFlow private Composer repo. Fires
 * when the admin opens the module's admin area. Re-added if dismissed; never
 * duplicated while an active entry for the same version exists. Fail-safe.
 */
class AddUpdateNotification implements ObserverInterface
{
    private const PACKAGE     = 'etechflow/module-admin-reindex';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-admin-reindex.json';
    private const CACHE_KEY   = 'etechflow_reindex_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Admin Reindex';
